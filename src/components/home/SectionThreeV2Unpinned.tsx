 ...
 *
 * SectionThreeV2 carries these same two values in its `NO_PIN_STAGE` fallback —
 * the branch it already switches to under reduced motion and on viewports too
 * short to pin. This component is that layout unconditionally, so the media
 ...
 * whole 0 → 1 spans exactly one viewport. Unpinned the section collapses to its
 * content — a fixed 684px — and that same offset would span `684 - 0.5·vh`:
...
export default function SectionThreeV2Unpinned() {
